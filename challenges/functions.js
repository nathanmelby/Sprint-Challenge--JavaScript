...
*/
function getDimensions(arr,cb){
  }

function consume(place1, place2, callback) {
  return callback (items.place1)(items.place2);
}

consume(items,function(add) {
 return num1+num2
})

consume(items,function(multiply) {
  return num1*num2
 })

 consume(items,function(greeting) {
